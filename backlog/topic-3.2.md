# Backlog - Topic 3.2 - Voltage, Current, Resistance and Power

Source: audit of the merged text (1,074 lines) against `STYLE-GUIDE.md`
...
- **Length:** 1,074 lines, inside the 700-1,200 target.
- **Looking Ahead** names the correct next topic.

## Items to apply

- [ ] [E] **6 deep URLs to convert to search form** (STYLE-GUIDE section 8).
...
- [ ] [C] **1 New Words missing from `glossary.md`:** `Coulomb`.
- [ ] [T] **Break markers: 1.** At 1,074 lines this wants three or four.
  Place them at the natural seams where the topic changes subject.
- [ ] [E] **The strongest candidate in the book for a Bitesize box.** Voltage,
  current, resistance and power are core KS3 physics and the reader meets them
  at school under those exact words. Use national-curriculum wording as the
  search term, per section 8.
- [ ] [T] **Check the worked examples.** This topic carries the arithmetic for
  V = I x R and P = V x I. Each needs question, known values, rule,
  calculation and the meaning in words, and each result should be checked -
  the figures were verified once when the topic landed but not since it was
  revised.
