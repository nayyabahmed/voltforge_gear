...
Source: audit of the merged text (1,101 lines) against `STYLE-GUIDE.md`
...
- **Length:** 1,101 lines, inside the 700-1,200 target.
- **Looking Ahead** names the correct next topic.

## Items to apply

- [ ] [E] **3 deep URLs to convert to search form** (STYLE-GUIDE section 8).
...
- [ ] [C] **6 New Words missing from `glossary.md`:** `Ackermann steering geometry`, `Free play`, `Movement envelope`, `Steering arm`, `Steering centre`, `Steering link`.
- [ ] [T] **Break markers: 1.** At 1,101 lines this wants three or four.
  Place them at the natural seams where the topic changes subject.
- [ ] [C] **Six missing glossary terms, the most in Part 3**, and several
  overlap with Topic 3.5. Sync the two topics' definitions when adding them
  so the same word does not get two different entries.
- [ ] [C] **"Ackermann steering geometry" here vs "Ackermann geometry" in
  3.10's vocabulary.** Pick one form for the registry and the glossary, and
  apply it in both.
