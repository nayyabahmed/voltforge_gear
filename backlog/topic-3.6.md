...
Source: audit of the merged text (1,187 lines) against `STYLE-GUIDE.md`
...
- **Length:** 1,187 lines, inside the 700-1,200 target.
...
- [ ] [C] **5 New Words missing from `glossary.md`:** `Brake force`, `Drag brake`, `Electronic commutation`, `Running mode`, `Thermal protection`.
- [ ] [T] **Break markers: 1.** At 1,187 lines this wants three or four.
  Place them at the natural seams where the topic changes subject.
- [ ] [T] **Check the throttle-calibration procedure end to end.** It is the
  one sequence in this topic a reader will follow literally with a powered
  ESC, and the wheels-off-the-ground rule must appear before the first step,
  not after it.
