...
Status: partially applied in dd772e8 (frontmatter already bumped to v0.2).
...
- [ ] [T] "Cause and Effect" (482-514): merge the one-line runs into short
  paragraphs.
...
- [ ] [V] Photo of a pinion meshing with a spur gear at the Interfaces
  section (~785).
