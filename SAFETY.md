...
version: "0.1"
status: "Draft (general rules from Topic 2.1; grows with each hazard's topic)"
---
...
- Soldering rules arrive with Topic 2.9.

*(expanded with Topics 2.2 and 2.9)*

## Cutting and Drilling

*(completed with Topic 2.8)*
...
*(expanded with Topics 3.1-3.2)*

## LiPo Batteries

LiPo batteries store a lot of energy and are the most serious hazard in this
hobby. The full rules arrive with Topic 3.3 (Batteries and Battery Safety).
The non-negotiables:
