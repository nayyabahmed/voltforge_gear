...
status: "Reviewed"
difficulty: Beginner
estimated_time: "90-120 minutes, including the safety card mini project"
prerequisites:
...
Why will your normal glasses not do? Because they were never tested for it. Safety glasses are made to a standard - in the UK and Europe that is **EN 166**, and you will find the number moulded into the frame or printed on the packet. Passing it means the lens has been fired at with a small steel ball and did not shatter into your eye. Ordinary spectacles have passed no such test, and they leave the sides open. Look for the EN 166 mark, and pick a pair sized for your face so they stay put.

> **[Sketch: safety glasses shown from the front and side. The front view marks the wrap-around side shield; a callout points to the EN 166 mark moulded into the arm. Beside them, ordinary spectacles are shown with arrows through the open gap at the side.]**
...
> **📚 Learn more**
>
> - BBC Bitesize (KS3 Design and Technology): search "health and safety" - the workshop rules, PPE and risk assessment as they are taught at school
> - Your tool's own manual - the manufacturer's safety pages are written for that exact tool, not for tools in general
...
> **🤔 Think about it.** Switch a desk lamp off at its own switch, then reach
> up and touch the bulb. Now do it again, but pull the plug out of the wall
> first. Both bulbs are off. Which one could somebody else turn back on while
> your fingers are on it?

That is the whole idea. A switch is a *promise* that the power is off. Pulling the plug is a *fact*. When your fingers are somewhere that would be hurt by the machine starting, you want the fact.
...
Our buggy will run on a LiPo (a lithium polymer battery - the rechargeable packs used in radio-controlled models, and the most serious hazard in this hobby; Topic 3.3 teaches them properly). The full battery topic is coming, but from today:
...
- Charge only with the correct charger and settings, only with an adult, only away from flammable clutter.
- Charge inside a **LiPo bag** - a fire-resistant pouch that a charging pack lives in.
- Never leave a battery charging unattended, bag or no bag.
- Disconnect the battery before mechanical work (you knew that one already).

That last pair go together, and the reason matters. A LiPo bag is made of fire-resistant cloth, and its job is to *contain* flame and sparks if a pack fails - to slow the problem down and keep it off your carpet. It is not a force field. It does not make an unattended charge safe, because the thing that actually saves you is a person noticing the pack swelling, hissing or smelling odd and acting early. The bag buys time; you have to be there to use it.
...
> **📚 Learn more**
>
> - Your charger's manual and your battery's label - between them they give the correct settings for your exact pack, which no general guide can
> - The [project safety card](../SAFETY.md) - the short version of every rule in this handbook, in one page
...
> **⚠️ SAFETY**
>
> A soldering iron tip runs at roughly 330-400 °C (Topic 2.9) and a printer
> nozzle at 200-250 °C (Topic 2.2) - hot enough to burn through skin faster
> than you can pull away. Both stay dangerous for many minutes after they are
> switched off. Never leave a hot tool out of its stand, and never hand one to
> somebody else tip-first.
...
> **⚠️ SAFETY**
>
> Craft knives, saws and drills are adult-supervised tools in this handbook -
> ask before you start, and build with an adult nearby. Changing a blade is an
> adult job: that is when a knife is at its most dangerous and your hands are
> closest to the edge.
...
> **⚠️ SAFETY**
>
> Before anything spins: clamp the work, glasses on, long hair tied back, cords
> and jewellery removed, both hands clear of the tool path. No loose gloves -
> fabric that catches in a spinning tool takes your hand with it. Let the tool
> stop completely on its own before you reach anywhere near it.

The one rule that prevents the classic drilling injury:

> Never hold a small part in your fingers while drilling it. Clamp it.

A drill bit can grab the part and spin it instantly - faster than you can let go. It stops being a part and becomes a propeller with sharp corners. Clamping also frees both hands to control the tool, which is why it is the first rule taught in every school workshop in the country.
...
> **⚠️ SAFETY**
>
> Solder fume, sanding dust and glue vapour are all things to keep out of your
> lungs. Open a window and keep your head out of the rising smoke - never lean
> over your work to see better while something is fuming. Wear a dust mask when
> sanding. Topics 2.8 and 2.9 cover each one properly.
...
> **[Signature visual: top-down plan of one ordinary desk divided into four
> labelled zones. Clean assembly zone holds a parts tray, screws and a small
> circuit board. Cutting and drilling zone holds a cutting mat with a clamped
> offcut. Hot-tool zone holds a soldering iron upright in its stand on a
> heatproof mat, with a dashed boundary and a small heat symbol. Storage zone
> holds labelled boxes and bags. A cable is drawn routed along the back edge,
> away from walking paths, and an arrow marks the clear route the reader's
> hands take between zones.]**
...
The full list, with what each tool is first needed for, lives in [TOOLS.md](../TOOLS.md). And remember that borrowing counts: family, school, library maker spaces and RC clubs all lend tools - learn the tool's rules, return it clean, and report any damage. If one of them offers an induction before you use their workshop, take it: an induction is this entire topic, taught hands-on, by somebody standing next to the actual machine.
...
> **🤔 Think about it.** Think of a time you nearly hurt yourself doing
> something ordinary - missed a stair, grabbed a hot mug, dropped a plate.
> You almost certainly still remember it. Now try to remember the last
> hundred times you climbed those stairs safely. Why does the near miss stick
> when the safe trips do not?

Because your brain files near misses as *lessons* and safe trips as *nothing happened*. Engineers do the same thing on purpose, in writing, because a near miss is a full-strength lesson that cost you nothing. It is the cheapest data you will ever get.
...
> The activities below build your actual workspace, and the mini project
> turns them into a card you will keep.
...
# Topic Mini Project - Your Workshop Safety Card 🛠️

Every topic in this handbook ends with one small build you get to keep. This one is a card that will sit beside your workspace for the whole project - your personal version of the project [safety card](../SAFETY.md).

## Materials

Household and scrap only:

- a piece of stiff card (a cereal box works)
- pens or markers
- a ruler and pencil
- optional: clear sticky tape or an old plastic wallet to waterproof it
- optional: string or a magnet to hang it up

> **⚠️ SAFETY**
>
> Show a responsible adult what you plan to make before you start, and make it
> with them nearby. This build uses nothing hot or sharp beyond scissors - ask
> the adult to approve your scissors and cut away from your body.

> **🎬 Watch the build**
>
> - Search "how to make a knowledge organiser poster" for simple, clear layout ideas you can copy for a one-page reference card
> - Ask your adult to show you the safety notice in their own workplace, kitchen or car manual - real safety cards are a design you can borrow from

## Build steps

1. Rule the card into three blocks: **Before work**, **During work**, **After work**.
2. Fill each block from what you learned in this topic. A starting set:
...
3. Add one line at the bottom in your own words about when *you* will stop work.
4. Add the three hazards you found in Activity 1, with the action you chose for each. This is what makes it *your* card rather than a copy of this book.
5. Decorate it, waterproof it if you like, and tape it where you will actually see it.

## Reflection - the part that matters

Look at your finished card and answer these in your notebook:

- Which of your rules removes a **hazard**, and which ones only lower the **risk**? You should find far more of the second kind. That is normal, and it is the main idea of this topic.
- Which single rule on your card would have prevented the most trouble in your workspace? Move it to the top.
- What is *not* on your card because you have not learned it yet? Leave a gap at the bottom labelled "Part 3 - batteries", and fill it in when you get there.

A safety card you made is one you will actually read. Keep it beside your bench - and put it on your showcase shelf at the end of the project, because it is the first thing you built for this buggy.
...
- LiPo packs charge in a **LiPo bag**, with the correct charger, and with a person nearby - the bag buys time, but only you can act on it.
...
| LiPo bag | A fire-resistant pouch a battery is charged inside, so a failure is contained. |
...
9. Why is a LiPo bag not a reason to leave a battery charging while you go out?
10. Your ordinary glasses are made of tough plastic. Why are they still not safety glasses?
11. What is a near miss, and what three lines should you write when one happens?
...
- [ ] I know that a charging battery needs a LiPo bag AND a person nearby.
- [ ] I made my workshop safety card and did its reflection step (mini project).
