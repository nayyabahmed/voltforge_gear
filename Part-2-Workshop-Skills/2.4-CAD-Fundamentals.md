...
A CAD model is that kind of instruction set. It stores shapes, sizes, positions and relationships so a computer can rebuild the design. For our buggy, CAD will create battery trays, electronics mounts, servo brackets, bumpers and adapters that match real parts rather than imagined ones.
...
> **[Sketch: one simple mounting plate shown in top, front, right and isometric CAD views; the same edges are highlighted across all four views]**
...
> **[Signature visual: four panels. Panel 1 shows a constrained 60 × 30 mm rectangle sketch centred on the origin. Panel 2 shows an arrow extruding it 4 mm into a plate. Panel 3 shows two Ø4 mm circle sketches constrained symmetrically. Panel 4 shows a cut feature creating two through-holes, beside a small feature-history list: Sketch 1 -> Extrude 1 -> Sketch 2 -> Cut 1.]**
...
For a servo mount, make the base and upright walls before cutting screw holes and the servo opening. Start with the packaging envelope from Topic 1.2: the component plus room for wires, fasteners, movement and access.
...
> **[Sketch: dimensioned top view of a 60 × 30 mm plate with two Ø4 mm holes. Each hole centre is 10 mm from its nearest short end. A centreline along the 30 mm width shows both holes constrained to the middle. A small front view shows 4 mm thickness.]**
