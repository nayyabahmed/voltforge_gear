...
Our buggy will need many parts like that: cable guides, receiver mounts, battery stops, spacers, brackets, covers and adapters. None is as exciting as a motor. Yet a two-millimetre error in one small mount can trap a battery, bend a wire or make the whole electronics tray impossible to remove.
...
> **[Sketch: top view of a small receiver. A solid rectangle shows the receiver body. A larger dashed rectangle shows its packaging envelope, including wire bend space at one end, finger access on one side and screw-head clearance around the mount.]**
...
> **[Sketch: top view of a cable-tie mount. Arrows show force entering at the central tie slot, spreading through two ribs, passing around the mounting holes and leaving through the two screws. A second version shows a decorative thick corner that is outside the load path and contributes little.]**
...
> **[Sketch: three top views of a mounting hole. Version A is too close to the edge and cracks. Version B has enough edge material but the screw head overlaps the wall. Version C provides edge distance, washer room and screwdriver access.]**
...
> **[Sketch: four cross-sections of the same ledge. A flat 90° overhang needs support; a 45° chamfer is self-supporting; a short bridge spans between two walls; a split two-part design places both pieces flat on the build plate.]**
...
> **[Sketch: dimensioned top and side views of the universal cable-tie mount. The 36 × 18 × 3 mm rounded base has two clearance holes on 24 mm centres, a rounded central slot and two shallow raised pads connected towards the slot by short ribs. A side view shows 3 mm base plus 1.5 mm local pads.]**
...
> **📚 Learn more**
>
> - Prusa Knowledge Base - search “Modeling with 3D printing in mind” for official examples of overhangs, thin walls, tolerances, orientation and splitting parts.
> - Tinkercad Learn - practise Align, Ruler, Hole, Duplicate and Group before modelling the universal mount.
> - Onshape Learning Centre - search “Design intent” and “Part design using sketches” to see how dimensions and relationships make revisions predictable.
