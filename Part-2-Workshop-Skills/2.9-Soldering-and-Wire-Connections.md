...
> **[Sketch: cross-section of a flexible wire. Many small copper strands form the conductor in the centre. A coloured plastic ring around them is labelled insulation. A second view shows a short stripped end with the strands exposed but uncut.]**
...
> **[Signature visual: four enlarged wire-to-terminal joints. Panel A shows solder flowing smoothly between wire and terminal and is labelled GOOD WETTING. Panel B shows a round blob stuck to the wire but not the terminal. Panel C shows a rough joint moved while cooling. Panel D shows too much solder bridging two neighbouring terminals.]**
...
> **📚 Learn more**
> - HSE - search “Solderer rosin flux fume” for official UK guidance on extraction, head position and overheating control.
> - Adafruit Learn - search “Guide to Excellent Soldering” for close-up photographs of tools, good joints and common faults; use with an adult.
> - SparkFun Learn - search “How to Solder Through-Hole Soldering” for a visual beginner tutorial on heating both parts, feeding solder and troubleshooting; use with an adult.
