...
> **[Sketch: a rectangular buggy bracket blank. One edge is labelled DATUM A. A thin cut line crosses the blank. The wanted side has a large tick; the waste side is shaded with diagonal lines. Two hole centres are marked with crossing centre lines.]**
...
> **[Signature visual: four cross-sections of the same plate. Panel 1 shows a drill wandering on an unmarked surface. Panel 2 shows a centre mark and small pilot hole. Panel 3 shows the plate clamped flat onto a backing board while a larger drill follows the pilot. Panel 4 shows the bit just breaking through into the backing board, leaving a supported clean exit. A contrasting inset shows an unsupported plate with a torn, raised exit burr.]**
...
> Wear eye protection and any respiratory protection required by the material guidance and risk assessment.
...
> **📚 Learn more**
> - HSE - search “general workshop safety” for suitable tools, good condition, eye protection and dust control.
> - HSE - search “work using electrically powered equipment” for inspection, isolation and electrical protection principles.
> - Original Prusa Knowledge Base - search “How to post-process the printed parts” for manufacturer examples of preparing printed holes and surfaces before assembly.
