...
> **⚠️ SAFETY**
>
> Never crush a soft battery pouch with an over-tight strap.
> A squashed cell can be damaged inside where you cannot see it, and a damaged cell is the one thing Topic 3.3 tells you never to charge or use.
> Follow the battery manufacturer's protection and mounting guidance, and show an adult the fitted strap before the real pack ever goes in.
...
> **📚 Learn more**
>
> - [Horizon Hobby - Firma ESC manual](https://www.horizonhobby.com/on/demandware.static/-/Sites-horizon-master/default/dwda06580f/Manuals/Firma-Manual-EN.pdf): a real ESC manual's guidance on ventilation, wiring and receiver supply. If the link has moved, search "Firma ESC manual" on horizonhobby.com.
...
> **📚 Learn more**
>
> - [Spektrum brushed ESC and receiver manual](https://www.horizonhobby.com/on/demandware.static/-/Sites-horizon-master/default/dwcf7cf482/Manuals/SPMXSE1040RX-Manual-EN.pdf): antenna placement, binding, failsafe and battery disconnection in one document. If the link has moved, search "SPMXSE1040RX manual" on horizonhobby.com.
...
> **☕ Good place to pause.**
> Everything is mounted and nothing is connected.
> The next sections are about the wires between them, which is where installations usually go wrong.
...
> **📚 Learn more**
>
> - Your exact battery, charger and radio manuals: the primary authority for installation, charging, storage, range and failsafe. No generic instruction outranks them.

# Recommission from Zero

> **🤔 Think about it.**
>
> Nothing electrical has changed since Topic 4.5. Same receiver, same servo, same ESC, same settings saved in the same transmitter. So why would anyone make you check the steering endpoints all over again?

Because the endpoints were never a property of the electronics. They were a property of the electronics *plus the mechanism they were driving*, and the mechanism is now completely different - different steering arms, different linkage lengths, different wheels, different weight on them. The servo will happily drive to the same saved position and jam a new linkage against a new hard stop.
...
Your buggy is now a real vehicle with a real battery in it, and that changes what the battery rules are for.

> **⚠️ SAFETY**
>
> If Version 1 uses a LiPo battery, every rule from Topic 3.3 still applies - nothing about installing the pack in a finished buggy relaxes any of them:
>
> - charging is adult-supervised, every time
...
>
> Stop and fetch an adult for anything on that list you are unsure about.
...
> **☕ Good place to pause.**
> Routed, inspected, labelled and still unpowered.
> The build brings the two paths together - with an adult, and from zero.

---

# Topic Build - Installed and Commissioned RC System 🛠️
