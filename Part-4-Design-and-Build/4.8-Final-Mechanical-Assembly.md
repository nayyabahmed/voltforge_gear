...
> **[Figure 4.8.1, Signature visual, F2 joint cross-section: one modular joint appears in four linked panels—tabs locate on clean datums, bolts clamp seated faces, a captured nut retains the bolt and a slot permits controlled adjustment. A crossed-out fifth panel shows a screw bending separated faces together. Six outer labels—identity, seat, align, move, retain and prove—connect the joint to the assembly release. Caption: Fasteners secure a correct relationship; they do not create one by force. Alt text: Modular printed joint distinguishes locating, clamping, retaining and adjusting from forced alignment.]**
...
> **[Figure 4.8.2, F4 sequence strip: six gated panels show identity audit, core seated on datums, rear drivetrain with freedom check, paired front suspension and steering, shocks and wheels, then unpowered alignment, roll and service proof. A stop sign appears whenever a new bind or mismatch is found. Caption: Assembly advances only while each added relationship remains understood. Alt text: Mechanical chassis is assembled in stages with movement and alignment checks between them.]**
...
> **[Figure 4.8.3, F1 annotated photograph: clean assembly station has printed modules grouped by revision, donor parts by stage, shallow labelled trays, fastener map, exact drivers, measurement tools, witness marker and a battery exclusion zone. Caption: An organised bench preserves component identity and makes the intended sequence visible. Alt text: Mechanical assembly station separates revisions, parts, fasteners, tools and records.]**
...
> **[Figure 4.8.4, F2 cross-section: four M3 fastener stacks show correct through-bolt length, blind-hole bottoming, a screw touching a gear and a head crushing printed plastic. Labels identify head style, washer, grip length, thread engagement and keep-clear depth. Caption: Diameter alone cannot tell whether a fastener is correct for its complete stack. Alt text: Fastener cross-sections compare safe engagement with bottoming, gear contact and plastic crushing.]**
...
- follow the donor/component manual
- use only where specified
- keep chemicals away from incompatible plastics
- use a tiny controlled amount
- allow the stated cure time
- have an adult handle chemical products and read the safety data

Do not put thread-locker on every screw.
Nylon lock nuts, captured nuts, correctly designed plastic threads and self-locking features work differently.
...
> **[Figure 4.8.5, F4 sequence strip: gearbox output, bearings and shafts, driveshafts, hubs, loose wheels and retained wheels are added one stage at a time. A resistance/sound card is completed after each spin, and stage four reveals the first hard point. Caption: The first changed reading identifies the assembly stage that introduced resistance. Alt text: Drivetrain is hand-spun after each component layer to isolate a bind.]**
...
> **[Figure 4.8.6, F7 comparison array: pinion and spur are shown too tight, usable and too loose in magnified side views, with rotation, backlash and tooth engagement arrows. A second strip checks the chosen mesh at four quarter-turn positions and across tooth width; “follow exact manual” sits above the array. Caption: Useful mesh must survive a full revolution and correct axial overlap, not only one convenient tooth position. Alt text: Gear mesh conditions and four-position runout check show model-specific adjustment evidence.]**
...
> **[Figure 4.8.7, F5 motion and measurement overlay: left and right suspension are assembled as mirrored stages, then compressed without shocks and with shocks. Defined ride-height points show 24.5 and 22.0 mm, while arrows point to preload, bind, twist and measurement method as possible causes. Caption: Symmetry is measured after movement is proved, not guessed from appearance. Alt text: Paired suspension build and ride-height measurement reveal a 2.5 millimetre difference.]**
...
> **[Figure 4.8.8, F6 measured drawing: two front wheels are shown at the same ride height with front spacing and rear spacing measured on a common horizontal line. Insets compare parallel, toe-in and toe-out and state the project sign convention; steering links clear the chassis through full hand movement. Caption: Toe becomes repeatable only when height, measurement points and sign convention are controlled. Alt text: Dimensioned front-wheel plan explains toe measurement and steering-clearance inspection.]**
...
> **[Figure 4.8.9, F7 comparison array: three household rehearsals show objects classified as locate/clamp/retain/adjust, paper fastener strips passing or entering a keep-clear zone, and a pencil shaft plus book wheels used for incremental freedom and toe measurements. Caption: Joint jobs, fastener length and alignment can be rehearsed without the real chassis. Alt text: Card and household activities model fastening, rotating alignment and toe.]**

# Topic Project - Final Mechanical Rolling Chassis 🛠️
...
> **[Figure 4.8.10, F4 sequence strip: final mechanical build moves from audited trays through core, rear drivetrain, paired suspension, steering and wheels to a flat-surface rolling chassis. Final panels show witness marks, five-run coast record and front/rear module removal. Caption: Mechanical release requires smooth movement, stable retention and planned service—not merely complete appearance. Alt text: Final unpowered chassis is assembled, inspected, roll-tested and serviced in controlled stages.]**
...
> **[Figure 4.8.11, F3 right-versus-wrong pair: left panel mixes all donor screws, clips, spacers and printed revisions in one tray; right panel follows an assembly traveller with staged packets, part codes and exact specialist retainers. Caption: Identity prevents a nearly correct part from entering the wrong mechanical job. Alt text: Mixed assembly hardware is contrasted with controlled staged parts and records.]**

## Mistake 2 - Tightening Before Datum Faces Seat

Fasteners should clamp the correct relationship, not bend it into place.

> **[Figure 4.8.12, F3 right-versus-wrong pair: left panel tightens across a visible face gap and curves the printed adapter; right panel cleans the datums, seats them by hand and inserts screws freely before cross-tightening. Caption: Seating proves the geometry before clamp load is added. Alt text: Bent misaligned printed joint is contrasted with clean seated datums and progressive tightening.]**

## Mistake 3 - Over-Tightening Printed Plastic

Stop at secure seating and follow specified torque where available.

> **[Figure 4.8.13, F3 right-versus-wrong pair: left panel shows a sunken screw head, whitening and a crack around a printed boss; right panel shows a flat seat, designed washer and undistorted witness mark. Caption: More turning after secure seating can remove strength rather than add it. Alt text: Crushed printed joint is contrasted with a securely seated undamaged fastener.]**

## Mistake 4 - Completing the Drivetrain Before Spinning It

Incremental tests reveal the exact source of resistance.

> **[Figure 4.8.14, F3 right-versus-wrong pair: left panel tests a fully assembled tight drivetrain with six possible causes marked; right panel records free rotation after gearbox, shafts, hubs and wheels and identifies the first change. Caption: Frequent hand checks turn one vague fault into one bounded assembly stage. Alt text: Complete drivetrain mystery is contrasted with incremental freedom evidence.]**
...
> **[Figure 4.8.15, F3 right-versus-wrong pair: left panel sets mesh once with a generic paper rule and floods a plastic joint with thread-locker; right panel follows the exact gear procedure, checks four rotational positions and applies a tiny approved amount only to the specified metal thread. Caption: Mesh and retention methods belong to the exact mechanism and materials. Alt text: Generic gear and chemical treatment is contrasted with manual-specific full-revolution checks.]**
...
> **[Figure 4.8.16, F3 right-versus-wrong pair: left panel hammers a tilted bearing and powers a servo against stiff steering; right panel stops, checks the coupon-proven seat and shaft alignment, then moves the disconnected steering by hand. Caption: Power multiplies a mechanical fault; it does not diagnose or correct it. Alt text: Forced bearing and powered binding are contrasted with alignment inspection and hand movement.]**
...
> **📚 Learn more**
>
> - Your donor manufacturer's official assembly manual - primary authority for order, fasteners, lubrication and settings.
> - Your motor/gearbox manufacturer's instructions - primary authority for pinion, gear mesh and securing methods.
...
5. Some joints use lock nuts, captured nuts or plastic threads, and thread-locking chemicals may be unnecessary or incompatible; use them only where specified.
