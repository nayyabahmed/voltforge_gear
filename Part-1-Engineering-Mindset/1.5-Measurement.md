...
>
> *Figure 1.5.E - A ruler reads to about a millimetre. Calipers read to a hundredth. Choose the tool the job actually needs.*
>
> *Alt text: A ruler and a digital caliper measuring the same part, with their readings compared.*
...
>
> *Figure 1.5.F - Reading a scale from an angle shifts the apparent value - line your eye up square first.*
>
> *Alt text: A scale read from directly above beside the same scale read from an angle, giving different apparent readings.*
...
>
> *Figure 1.5.G - Zero the calipers closed, before every set of measurements. A tool that starts wrong stays wrong.*
>
> *Alt text: A digital caliper closed with the display reading zero, and a second showing a small non-zero offset.*
...
>
> *Figure 1.5.H - Squeeze a soft part and it gets smaller - which is why a rubber tyre has no single true thickness.*
>
> *Alt text: A caliper measuring a soft rubber part lightly and then firmly, giving two different readings.*
