...
> **[F5 force and motion overlay - Figure 1.4.B: side view of a beam bowing downward under a central load - top edge labelled "squeezed (compression)", bottom edge labelled "stretched (tension)", dashed centre line labelled "neutral - neither"]**
>
> *Figure 1.4.B - Follow the force from where it enters to where it leaves - the narrowest point is where it will break.*
>
> *Alt text: A load path traced through a buggy part from the point of loading to its mountings.*
...
>
> *Figure 1.4.C - The same force through a smaller area means more stress - which is why thin sections fail first.*
>
> *Alt text: Cross-sections comparing the same force spread over a wide area and concentrated in a narrow one.*
...
>
> *Figure 1.4.D - Strength is when it breaks. Stiffness is how much it bends first. A part can be strong and floppy, or stiff and brittle.*
>
> *Alt text: A comparison of strong, weak, stiff and flexible behaviour under the same load.*
...
>
> *Figure 1.4.E - Elastic bending springs back. Permanent bending does not - and the part never returns to its designed shape.*
>
> *Alt text: A part bending and returning to shape beside one bent permanently out of shape.*
...
>
> *Figure 1.4.F - A long thin part under compression does not squash - it suddenly folds sideways.*
>
> *Alt text: A slender strut under compression buckling sideways rather than shortening.*
...
>
> *Figure 1.4.G - Folding a flat sheet moves material away from the middle, which is where bending is resisted.*
>
> *Alt text: A flat sheet bending easily beside the same sheet folded into a channel resisting the same load.*
...
>
> *Figure 1.4.I - Fatigue is failure by repetition - each cycle does almost nothing, and then one of them is the last.*
>
> *Alt text: A part cycling under load with a crack growing from a corner over successive cycles.*
