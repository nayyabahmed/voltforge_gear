...
>
> *Figure 1.6.B - A caliper that does not read zero when closed adds the same error to every measurement you take with it.*
>
> *Alt text: A caliper closed reading zero beside one closed reading a small offset.*
...
>
> *Figure 1.6.C - Random error scatters readings around the truth. Systematic error shifts them all the same way.*
>
> *Alt text: Two scatter plots comparing randomly scattered readings around a true value with readings all offset to one side.*
...
>
> *Figure 1.6.D - Three parts each within tolerance can still stack into an assembly that is well outside it.*
>
> *Alt text: Three blocks each slightly oversize stacked into a column noticeably longer than intended.*
