...
> **[F7 comparison array - Figure 1.3.B: two panels side by side. Left: a drawer sliding out along a straight arrow, labelled linear motion, with the arrow showing a single direction of travel. Right: a wheel turning about its centre, labelled rotational motion, with a curved arrow around the axle and a fixed point marked at the middle]**
>
> *Figure 1.3.B - Linear motion goes somewhere. Rotational motion goes round. Almost every machine turns one into the other.*
>
> *Alt text: A drawer sliding along a straight arrow beside a wheel turning about its centre.*
...
> **[Signature visual, F5 force and motion overlay - Figure 1.3.C: a top view of a door with its hinge on the left. Two identical force arrows push on the door, one close to the hinge and one out at the handle, each with its distance from the hinge dimensioned. A curved arrow shows the door swinging easily from the handle push, while the near-hinge push barely moves it. The two distances are labelled as the lever arm]**
>
> *Figure 1.3.C - The same push, in two places, does completely different amounts of work - which is the whole idea of torque.*
>
> *Alt text: Top view of a door with equal forces applied near the hinge and at the handle, their distances dimensioned.*
...
> **[F5 force and motion overlay - Figure 1.3.D: a top-down view of the buggy driving round a left-hand curve, with dashed arcs traced by the inside and outside wheels. The outside arc is clearly longer and both arcs are labelled with their path length. A note marks that both wheels take the same time, so the outer wheel must turn faster]**
>
> *Figure 1.3.D - In every corner the outside wheel travels further than the inside one - which is the problem the differential exists to solve.*
>
> *Alt text: Top-down view of a buggy cornering with dashed arcs showing the outside wheel travelling a longer path.*
...
> **[F5 force and motion overlay - Figure 1.3.E: a side view of a driven wheel resting on the ground, magnified at the contact patch. One arrow at the contact patch points backward, labelled tyre pushes ground. An equal and opposite arrow points forward, labelled ground pushes tyre. The buggy outline above shows which way it therefore moves]**
>
> *Figure 1.3.E - The buggy does not pull itself forward - it pushes the ground backward, and the ground pushes back just as hard.*
>
> *Alt text: A driven wheel magnified at the contact patch with equal opposing arrows for the tyre pushing back and ground pushing forward.*
...
> **[F2 cross-section - Figure 1.3.F: a 10-tooth pinion meshing with a 40-tooth spur gear, teeth interlocking at the contact point. A curved arrow on the pinion is labelled 4 turns and a curved arrow on the spur gear is labelled 1 turn, running the opposite way. Beneath, two bars compare speed and torque: the pinion high in speed and low in torque, the spur gear the reverse]**
>
> *Figure 1.3.F - Four turns in, one turn out - and what you lose in speed you gain in turning strength.*
>
> *Alt text: A 10-tooth pinion meshing with a 40-tooth gear, marked with four turns to one, and speed and torque compared.*
...
> **[F5 force and motion overlay - Figure 1.3.G: two side views of the buggy. Top, accelerating: the nose lifts and the rear squats, with thick arrows showing extra load pressing on the rear tyres and lighter arrows at the front. Bottom, braking: the nose dives and thick arrows show extra load on the front tyres instead. A dashed line marks the resting ride height in both so the change is visible]**
>
> *Figure 1.3.G - Weight does not stay where you put it - accelerating and braking move it backwards and forwards between the tyres.*
>
> *Alt text: Two side views of a buggy showing weight transferring to the rear under acceleration and to the front under braking.*
...
> **[F5 force and motion overlay - Figure 1.3.A: a side view of the buggy with both paths drawn on the same outline. A green arrow chain traces the motion path from motor through gears, differential and driveshafts to the wheels. A separate orange arrow chain traces the support path upward from the ground contact patch through tyre, wheel, hub and suspension into the chassis. The two chains meet at the wheel and are clearly different colours, with a note marking the suspension mount as the part that carries the support load]**
>
> *Figure 1.3.A - Both paths pass through the wheel, but they carry different things in different directions - which is why a perfect drivetrain can sit on a broken suspension mount.*
>
> *Alt text: A buggy side view with the motion path traced from motor to wheels and the support path traced from ground up through suspension to chassis.*
...
1. Linear motion travels in a straight line from one place to another. Rotational motion turns about a fixed centre. A drawer slides; a wheel spins.
2. A push or a pull acting on an object. A force can start movement, stop it, speed it up, slow it down or change its direction.
3. The turning effect of a force acting at a distance from a centre of rotation. It depends on both how hard you push and how far from the centre you push.
4. Because torque depends on distance from the hinge as well as on force. Pushing at the handle gives a long lever arm, so the same push produces far more turning effect than the same push applied close to the hinge.
5. Revolutions per minute - how many complete turns something makes in one minute. It measures rotational speed, not power and not torque.
6. Motor, pinion, spur gear, differential, driveshafts, axles, wheels, tyres, ground.
7. Because the outside wheel travels a longer path than the inside wheel in a corner, and both take the same time. The differential lets the two driven wheels turn at different speeds, so neither has to skid to keep up.
8. That the input turns four times for every one turn of the output. Speed is divided by four and torque is multiplied by roughly four, minus losses.
9. Lower gearing means more turns of the motor per turn of the wheel: more torque at the wheels, stronger acceleration, but a lower top speed.
10. Higher gearing means fewer motor turns per wheel turn: a higher top speed, but less torque, weaker acceleration, and more strain on the motor and battery.
11. Any two: the tyres gripping the ground so the buggy can accelerate and steer, brake pads slowing a wheel, a screw thread staying tight under vibration, or your fingers gripping a tool.
12. Any two: a tight or dirty bearing, badly meshed gears rubbing, a bent driveshaft dragging, or a wheel rubbing on the bodywork. All of them turn useful energy into heat.
13. Because grip has a limit. If the torque at the wheel exceeds what the tyre can transmit to the ground, the tyre slides instead of gripping. The wheel spins fast, but very little force reaches the ground, so the buggy accelerates poorly.
14. The tendency of an object to keep doing what it is already doing - staying still if still, or continuing to move if moving. More mass means more inertia, so more force is needed to change its motion.
15. Because it carries more energy of movement. That energy depends on both mass and speed, and speed matters most, so a heavier and faster buggy has considerably more energy to get rid of when it stops suddenly against something.
16. The motion path carries rotation outward from the motor to the wheels. The support path carries force back from the ground up through the tyres, wheels, hubs and suspension into the chassis. One delivers movement; the other carries the loads that movement creates.
17. Because the rest of the drivetrain was designed around the original motor's torque. A more powerful motor pushes more torque through the same gears, shafts and mounts, and the weakest of those parts now sees a load it was never sized for - so it strips or snaps.
18. "Where does the motion stop?" Turn the wheels or the motor by hand and follow the chain from motor to tyre, finding the first place where movement no longer passes on. That locates the break instead of guessing at it.
